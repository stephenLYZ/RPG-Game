...
var data = require('./map.js')
var mapData = data.mapData
var foregroundData  = data.foregroundData
...
var game = function(){
	...
	game.items = [
		{price: 100,description: "Hurter",id: 0},
		{price: 300,description: "Drg. Paw",id: 1},
		{price: 300,description: "Ice Magic",id: 2},
	...
	var setPlayer = function(){
		...
		player.direction = 0
		player.walk = 0
		player.frame = player.spriteOffset + player.direction * 2
	...
	var setShopping = function(){
		...
		shop.greeting = "Hi! I'm Maneki. I sell things"
	...
	var setBattle = function(){
		...
		battle.won = function(){
			...
			if(player.exp > player.levelStats[player.level].expMax){
				player.level += 1
				player.statusLabel.text = player.statusLabel.text + "<br />And you gained a level!" + "<br /> You are now at level "+ player.level + "!"
